...
```
WTF: ```gsa://onpageload```
Answer: Might be related to Google Search Appliance. (to confirm?)
...
```
WTF: Ghostery???
Answer: Might be generated by inline-styles (if not allowed) by Ghostery extension on Firefox. It is related to this bug of bookmarklets/extensions https://bugzilla.mozilla.org/show_bug.cgi?id=866522, and reported https://bugzilla.mozilla.org/show_bug.cgi?id=866522#c73 (to confirm)

If you have some examples to share (even if you don't know what the fuck it is), feel free to share them. Anonymize the URL/policy if needed.
